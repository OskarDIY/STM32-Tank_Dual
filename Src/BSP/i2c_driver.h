...
typedef struct
{
	...
	uint32_t            dmaPerif;
	uint32_t            dmaChannel;
	DMA_Channel_TypeDef* dmaRxStream;
	uint32_t            dmaRxIRQ;
	uint32_t            dmaRxTCFlag;
	uint32_t            dmaRxTEFlag;
	
	DMA_Channel_TypeDef* dmaTxStream;
	uint32_t            dmaTxIRQ;
	uint32_t            dmaTxTCFlag;
	uint32_t            dmaTxTEFlag;
...
typedef struct
{
	...
	DMA_InitTypeDef rxDMAStruct;            //< DMA configuration structure used during transfer setup.
	DMA_InitTypeDef txDMAStruct;            //< DMA configuration structure used during transfer setup.
} I2cDrv;
