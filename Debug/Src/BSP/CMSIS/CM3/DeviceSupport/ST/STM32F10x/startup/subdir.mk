...
Src/BSP/CMSIS/CM3/DeviceSupport/ST/STM32F10x/startup/%.o: ../Src/BSP/CMSIS/CM3/DeviceSupport/ST/STM32F10x/startup/%.s Src/BSP/CMSIS/CM3/DeviceSupport/ST/STM32F10x/startup/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m3 -g3 -DDEBUG -c -I"D:/ProgramData/STM32CubeIDE/workspace_1.10.1/Tank_Dual_Pro/Src/BSP/CMSIS/CM3/DeviceSupport/ST/STM32F10x/startup" -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@" "$<"
